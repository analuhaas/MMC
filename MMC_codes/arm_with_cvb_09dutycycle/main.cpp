...
/**
 * @brief  This example deploys the open-loop control of a MMC arm integrating a Capacitor Voltage Balancing algorithm with modified connected state duty cycle of 0.9 instead of 1. 
