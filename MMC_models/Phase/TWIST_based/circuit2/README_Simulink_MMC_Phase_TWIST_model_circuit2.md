# MMC phase test simulation with open-loop control using CVB algorithm in Simulink with TWIST-based MMC module model (circuit #2)
...
The Simulink circuit of MMC_phase_hackathon_circuit2_HAAS_20260216.slx represents the experimental test circuit 2 for the phase. Extra capacitances can be added to the module via Vhigh terminals of the modules such as done experimentally.

<img width="884" height="722" alt="image" src="https://github.com/user-attachments/assets/dadb842b-0547-4441-8232-c87a7497e991" />
...
The simulation can be configured using the following inputs on the script_MMC_phase_circuit2_twist_20260216.m file:
...
```
latest_sim_name = 'MMC_phase_hackathon_circuit2_HAAS_20260216.slx'; % Simulink simulation to execute
latest_test_parameters = "param_phase_circuit2_HAAS_20260216.m"; % Circuit parameters (udc, R, etc...)
...
1.	Clone this repository or download the "circuit2" folder in your PC.
2.	In matlab, go to "circuit2" folder.
3.	Open script_MMC_phase_circuit2_twist_20260216.m file.
4.	Configure your simulation using the script inputs.
5.	Save and run script_MMC_phase_circuit2_twist_20260216.m.
