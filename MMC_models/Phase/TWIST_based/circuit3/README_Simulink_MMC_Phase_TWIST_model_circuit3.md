# MMC phase test simulation with open-loop control using CVB algorithm in Simulink with TWIST-based MMC module model (circuit #3)
...
The simulation can be configured using the following inputs on the script_MMC_phase_circuit3_twist_20260216.m file:
...
```
latest_sim_name = 'MMC_phase_hackathon_circuit3_HAAS_20260216.slx'; % Simulink simulation to execute
latest_test_parameters = "param_phase_circuit3_HAAS_20260216.m"; % Circuit parameters (udc, R, etc...)
...
1.	Clone this repository or download the "circuit3" folder in your PC.
2.	In matlab, go to "circuit3" folder.
3.	Open script_MMC_phase_circuit3_twist_20260216.m file.
4.	Configure your simulation using the script inputs.
5.	Save and run script_MMC_phase_circuit3_twist_20260216.m.
