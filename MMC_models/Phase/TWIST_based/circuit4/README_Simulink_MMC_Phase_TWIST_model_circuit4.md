# MMC phase test simulation with open-loop control using CVB algorithm in Simulink with TWIST-based MMC module model (circuit #4)
...
The Simulink circuit of MMC_phase_hackathon_circuit4_HAAS_20260216.slx represents the experimental test circuit 4 for the phase. Extra capacitances can be added to the module via Vhigh terminals of the modules such as done experimentally.

<img width="892" height="727" alt="image" src="https://github.com/user-attachments/assets/189ab877-137a-4d87-a62a-2de231605a09" />
...
The simulation can be configured using the following inputs on the script_MMC_phase_circuit4_twist_20260216.m file:
...
```
latest_sim_name = 'MMC_phase_hackathon_circuit4_HAAS_20260216.slx'; % Simulink simulation to execute
latest_test_parameters = "param_phase_circuit4_HAAS_20260216.m"; % Circuit parameters (udc, R, etc...)
...
out.ia : stores the phase AC current
out.iSigma : stores the phase differential current (idc/3 + circulating current)
...
1.	Clone this repository or download the "circuit4" folder in your PC.
2.	In matlab, go to "circuit4" folder.
3.	Open script_MMC_phase_circuit4_twist_20260216.m file.
4.	Configure your simulation using the script inputs.
5.	Save and run script_MMC_phase_circuit4_twist_20260216.m.
