# MMC stack test simulation with open-loop control using modified CVB algorithm in Simulink with TWIST-based MMC module model
...
The Simulink circuit of MMC_stack_openloop_NLM_CVBmodified_twist_HAAS_20260219.slx represents the experimental test circuit. Extra capacitances can be added to the module via Vhigh terminals of the modules such as done experimentally.
...
The simulation can be configured using the following inputs on the script_MMC_stack_openloop_NLM_CVBmodified_twist_HAAS_20260219.m file:
...
1.	Clone this repository or download the "CVB_modified" folder in your PC.
2.	In matlab, go to "CVB_modified" folder.
3.	Open script_MMC_stack_openloop_NLM_CVBmodified_twist_HAAS_20260219.m file.
4.	Configure your simulation using the script inputs.
5.	Save and run script_MMC_stack_openloop_NLM_CVBmodified_twist_HAAS_20260219.m.
